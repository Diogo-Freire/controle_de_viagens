...
<body>
    ...
    <div class="main-content">
        ...
        <div class="details">
            <p><strong>Nome:</strong> {{ $motoristas->nome }}</p>
            <p><strong>Data de nascimento:</strong> {{ $motoristas->data_nascimento }}</p>
            <p><strong>Número da CNH:</strong> {{ $motoristas->cnh }}</p>
        </div>
        <br>
        <a href="{{ route('motoristas.index') }}">Voltar para a Lista de Motorista</a>
    </div>
</body>
</html>
